...
# precision of the calculations might accumulate to differences big enough for the tests to fail. As the
...
test_that("getOmega works for normality tests", {
  ...
  expect_equal(omega_n23t[3, ], c(9.476058, 31.364721, 145.473749), tolerance=1e-3)
  expect_equal(omega_n23t[3, 2], 31.36472, tolerance=1e-1)
...
test_that("getOmega works for autocorrelation test", {
  ...
  expect_equal(omega_ac1_23t[1, 1], 0.8719067, tolerance=1e-3)
  ...
  expect_equal(omega_ac3_23t[1, 1], 0.8769805, tolerance=1e-3)
  expect_equal(omega_ac3_23t[2, ], c(0.1645746, 0.7979296, 0.0148655), tolerance=1e-3)
})
...
test_that("getOmega works for conditional heteroskedasticity tests", {
  ...
  expect_equal(omega_ch1_23t[1, 1], 10.93848, tolerance=1e-3)
  ...
  expect_equal(omega_ch3_23t[3, ], c(-1.54953644, -0.05031768, 4.42308303), tolerance=1e-3)
  expect_equal(omega_ch3_23t[, 2], c(1.93888644, 5.14543685, -0.05031768), tolerance=1e-3)
})
