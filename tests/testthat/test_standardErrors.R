...
test_that("standardErrors work", {
  expect_equal(standardErrors(simudata, p=1, M=1, params=params11t, model="StMAR"),
               c(0.31627663, 0.02582825, 0.28359778, 0.36390871), tolerance=1e-2)
  expect_equal(standardErrors(simudata, p=1, M=2, params=params12, model="GMAR"),
               c(0.63767937, 0.05622560, 0.05026257, 1.48243852, 0.09497417, 0.36394897, 0.15529767), tolerance=1e-2)
  expect_equal(standardErrors(simudata, p=1, M=c(1, 1), params=params12gs, model="G-StMAR"),
