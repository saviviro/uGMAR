...
#' @param gsmar object of class \code{'gsmar'}, generated by function \code{fitGSMAR} or \code{GSMAR}.
#' @param nsimu a positive integer specifying how many values will be simulated.
#' @param initvalues a numeric vector with length \code{>=p} specifying the initial values for the simulation. The \strong{last} element will be used as the
#'  initial value for the first lag, the second last element will be initial value for the second lag, etc. If not specified, initial
#'  values will be simulated from the process's stationary distribution.
...
#' @details The argument \code{ntimes} is intended for forecasting. One can easily perform a large number simulations and calculate the
#'  sample quantiles from the simulated values to obtain prediction intervals (see the examples).
...
#'
#'  # FORECASTING EXAMPLE:
#'  # Restricted GMAR model, 1000 sets of simulations and aggregate results
