...
* Now standard errors are printed correctly for model imposing all kinds of constraints. In earlier versions, the constraint AR parameter standard errors were printed incorrectly if the constraints involved multiplications or summations. 
